            ...
            <div className="flex items-center justify-between mb-8">
                ...
                <div className="flex items-center space-x-3">
                    <div className="relative">
                        ...
                        <ChevronDown className="absolute right-3 top-2.5 w-4 h-4 text-slate-500 dark:text-slate-400 pointer-events-none" />
                    </div>
                    ...
                    displayProducts.map((product) => (
                        ...
                        >
                            ...
                            <div
                                ...
                                className={`w-6 h-6 mr-6 rounded-md border-2 flex items-center justify-center transition-colors ${selectedIds.has(String(product._id || product.id)) ? 'bg-blue-600 border-blue-600' : 'border-slate-300 dark:border-slate-700 hover:border-blue-500'
                                    }`}
                            >
                                    ...
                                    <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 mt-2">
                                        ...
                                        <div className="flex flex-wrap gap-x-4 gap-y-1">
                                            ...
                                            {product.reviews !== undefined && (
                                                <div className="flex items-center space-x-1 sm:border-l border-slate-200 dark:border-slate-700 sm:pl-4">
                            ...
                            <div className="mt-4 md:mt-0 md:pl-8 border-t md:border-t-0 md:border-l border-slate-200 dark:border-slate-800 flex flex-row md:flex-col items-center justify-center space-x-4 md:space-x-0 md:space-y-3 w-full md:w-auto pt-4 md:pt-0">
