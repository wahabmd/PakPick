...
const SellerDashboard: React.FC<SellerDashboardProps> = ({ shopData }) => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="glass-card p-6 border-l-4 border-l-red-500">
                    <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-[10px] bg-red-500/10 text-red-500 px-2 py-0.5 rounded font-bold">CRITICAL</span>
                    </div>
                    <div className="text-slate-500 text-[10px] font-bold uppercase tracking-wider mb-1">Lost Opportunity</div>
                    <div className="text-2xl font-black text-red-400">PKR 4,200</div>
                    <div className="text-[9px] text-slate-500 mt-1 italic">Due to out-of-stock items</div>
                </div>
            </div>
